...
| 서버 IP | 133.186.218.40 |
| 앱 경로 | /var/mindra/auto-blog |
...
### 2. 서버 접속
```bash
서버아이피 133.186.144.41
pem 파일 경로 D:\00.Work\mindra-devkwak.pem
서버 경로 /var/mindra/auto-blog
```

### 3. 저장소 클론
```bash
git clone https://github.com/devkwak73/auction-blog.git /var/mindra/auto-blog
```
